...
class HymnCategoryPolicy
{
     ...
     */
    public function update(Admin $user, HymnCategory $hymnCategory): bool
    {
        return ! $this->isGuest($user);
    }
     ...
     */
    public function delete(Admin $user, HymnCategory $hymnCategory): bool
    {
        return ! $this->isGuest($user);
    }
